...
// table= loadTable( "data/new.csv");
  ...
  while (bxkarte!=feld&&bykarte!=feld&&bzkarte!=feld) {
    ...
    if (x[bxkarte]!=0&&y[bykarte]!=0&&z[bzkarte]!=0 ) {  
      tag.append(table.getInt(0, "page1"));
      if (tag.size()==5+food4)
        tag.remove(0);
      feld=6+stone3;
  ...
  while (stone1!=0) {
    ...
    if (stone.size()<=0)
      stone.append(table.getInt(1, "page1"));
    if (stone1==stone.get(0)) {
      pushMatrix();
      translate(100+karte*axkarte, 250+karte*aykarte, karte*azkarte );
  //    println( stone.get(0));
  ...
  while (food3!=0) {
    ...
    if (food.size()<=0)
      food.append(table.getInt(2, "page1"));
    if (food3==food.get(0)) {
      pushMatrix();
      translate(100+karte*axkarte, 250+karte*aykarte, karte*azkarte );
 ...
 speeds1=feld*feld*feld;
  ...
  while (speeds1!=0) {
    ...
    if (speed.size()<=0)
      speed.append(table.getInt(3, "page1"));
    if (speeds1==speed.get(0)) {
      pushMatrix();
      translate(100+karte*axkarte, 250+karte*aykarte, karte*azkarte );
    //  println( speed.get(0));
