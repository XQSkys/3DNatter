...
public class sketch_3DNatter_v0_4_1mouse extends PApplet {
...
ambientLight(102, 102, 102);
  ...
  rect(0, 0, 800, 800);
  popMatrix();
   if((mouseoverx>100&&mouseoverx<700)&&(mouseovery>0&&mouseovery<100)){sense=mouseovery*1.2f;};
...
int i = 0;   
 ...
 speeds1=feld*feld*feld;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_3DNatter_v0_4_1mouse" };
    if (passedArgs != null) {
