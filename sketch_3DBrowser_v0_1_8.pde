  ...
  table.addColumn("page0", Table.INT);
   ...
   table.addColumn("page2", Table.INT);
    table.addColumn("page3", Table.INT);
      table.addColumn("page4", Table.STRING);
         table.addColumn("page5", Table.STRING);
               table.addColumn("page6", Table.STRING);
                   table.addColumn("page7", Table.STRING);
                   table.addColumn("page8", Table.STRING);
                   table.addColumn("page9", Table.STRING);
...
// table= loadTable( "data/new.csv");
 ...
 table.setInt(0, "page1", stone.get(0));
saveTable(table, "data/new.csv");
        println(table.getInt(0, "page1"));
 table.setInt(0, "page2", food.get(0));
saveTable(table, "data/new.csv");
       println(table.getInt(0, "page2"));
table.setInt(0, "page3", speed.get(0));
 saveTable(table, "data/new.csv");
        println(table.getInt(0, "page3"));
save=0;
   }
 
 if(load==1){
stone3=table.getInt(0, "page0");
stone.set(0,table.getInt(0, "page1"));
food.set(0,table.getInt(0, "page2"));
speed.set(0,table.getInt(0, "page3"));
